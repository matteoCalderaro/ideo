...
var checkbox = document.querySelector('#navi-toggle');
...
///////////////////////////////////////////////////////////
// Sticky navigation
var header = document.querySelector('.header__text-box');
var obs = new IntersectionObserver(function (entries) {
  var ent = entries[0];
  console.log(ent);
  var button = document.querySelector('.navigation__button');
  var background = document.querySelector('.navigation__background');
